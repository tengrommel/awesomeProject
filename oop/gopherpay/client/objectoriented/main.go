...
import (
	"awesomeProject/oop/payment/objectoriented"
	"fmt"
	"strings"
)
...
func main() {
	...
	credit := objectoriented.CreateCreditAccount("Debra Ingram", "1111-2222-3333-4444", 5, 2021, 123)
	...
	checking := objectoriented.CreateCheckingAccount("Debra Ingram", "01010011", "0551005115100")
